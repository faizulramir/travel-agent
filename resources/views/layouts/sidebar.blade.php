            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                @if (auth()->user()->hasAnyRole('tra'))
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{ route('excel_list') }}" key="t-excel-list">EXCEL LIST</a></li>
                        </ul>
                    </li>
                @endif
                ...
                @if (auth()->user()->hasAnyRole('ag'))
                    <li>
                        <a href="javascript: void(0);" class="has-arrow waves-effect">
                            <i class="bx bxs-shopping-bag-alt"></i>
                            <span key="t-ta">AGENT (AGE)</span>
                        </a>
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{ route('excel_list_agent') }}" key="t-excel-list">EXCEL LIST</a></li>
                        </ul>
                    </li>
                @endif
                ...
                @if (auth()->user()->hasAnyRole('fin'))
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{ route('excel_list_finance') }}" key="t-excel-list">EXCEL LIST</a></li>
                        </ul>
                    </li>
                @endif
                ...
                @if (auth()->user()->hasAnyRole('akc'))
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{ route('excel_list_admin') }}" key="t-excel-list-admin">EXCEL LIST</a></li>
                            <li><a href="{{ route('user_list') }}" key="t-user-list">USER LIST</a></li>
                ...
                @if (auth()->user()->hasAnyRole('ind'))
                    <li>
                        <a href="javascript: void(0);" class="has-arrow waves-effect">
                            ...
                            <span key="t-ta">INDIVIDU (IND)</span>
                        </a>
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{ route('application_list') }}" key="t-application">APPLICATION</a></li>
                        </ul>
                    </li>
                @endif
                ...
                {{-- <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('tambah_produk') }}" key="t-tambah-produk">TAMBAH PRODUK</a></li>
                        <li><a href="{{ route('senarai_produk') }}" key="t-senarai-produk">SENARAI PRODUK</a></li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        <i class="bx bx-sticker"></i>
                        <span key="t-produk">PELEKAT MYORI</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('tempahan_pelekat') }}" key="t-tambah-produk">TEMPAHAN PELEKAT</a></li>
                        <li><a href="{{ route('rekod_pelekat') }}" key="t-senarai-produk">REKOD PELEKAT</a></li>
                        <li><a href="{{ route('senarai_invois') }}" key="t-senarai-produk">SENARAI INVOIS</a></li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        <i class="bx bx-health"></i>
                        <span key="t-produk">ADUAN</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('senarai_aduan') }}" key="t-tambah-produk">SENARAI ADUAN</a></li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        ...
                        <span key="t-produk">JEJAKAN</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="#" key="t-tambah-produk">JEJAKAN PRODUK</a></li>
                    </ul>
                </li> --}}
                ...
                {{-- <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        ...
                        <span key="t-penguatkuasaan">PENGUATKUASAAN</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('kes_baru') }}" key="t-kes-baru">ADUAN BARU</a></li>
                        <li><a href="{{ route('kes_dalam_siasatan') }}" key="t-kes-siasat">ADUAN DALAM TINDAKAN</a></li>
                        <li><a href="{{ route('kes_selesai') }}" key="t-kes-selesai">ADUAN SELESAI</a></li>
                        <li><a href="{{ route('kes_tiada_tindakan') }}" key="t-kes-tiada-tindakan">ADUAN TIADA TINDAKAN</a></li>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        ...
                        <span key="t-pengilang">PENGILANG</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('senarai_pengilang') }}" key="t-senarai-pengilang">SENARAI PENGILANG</a></li>
                        </li>
                    </ul>
                </li> --}}
