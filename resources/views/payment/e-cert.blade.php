    ...
    <body style="background-image: url({{ $url_bg }}); background-repeat: no-repeat; background-attachment: fixed;  background-size: cover;">
        ...
        <div class="row">
            <div class="column-second" style="width: 60%;">
                <p style="padding-top: {{ strlen($orders->upload->ta_name) > 27 ? '14px' : '10px' }}; font-size: {{ strlen($orders->upload->ta_name) > 27 ? '18px' : '22px' }};"><b>{{ strtoupper($orders->upload->ta_name) }}</b></p>
